    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm10Building"], // Updated field name
                "filter": {
                    "%ufCrm10Building": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueBuildings.has(item.ufCrm10Building)) {
                                uniqueBuildings.add(item.ufCrm10Building);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm10Building;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm10Building;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
