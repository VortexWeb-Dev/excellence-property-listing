            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueCities.has(item.ufCrm10City)) {
                                uniqueCities.add(item.ufCrm10City);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm10City;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm10City;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
