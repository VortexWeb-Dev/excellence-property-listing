    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm10Community"], // Updated field name
                "filter": {
                    "%ufCrm10Community": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueCommunities.has(item.ufCrm10Community)) {
                                uniqueCommunities.add(item.ufCrm10Community);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm10Community;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm10Community;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
