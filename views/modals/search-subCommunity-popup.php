    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm10SubCommunity"], // Updated field name
                "filter": {
                    "%ufCrm10SubCommunity": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueSubCommunities.has(item.ufCrm10SubCommunity)) {
                                uniqueSubCommunities.add(item.ufCrm10SubCommunity);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm10SubCommunity;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm10SubCommunity;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
