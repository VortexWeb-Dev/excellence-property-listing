...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const fetchAndDisplayOptions = async () => {
            try {
                const agentsResponse = await fetch(`${baseUrl}/crm.item.list?entityTypeId=${AGENTS_ENTITY_ID}&select[0]=ufCrm8AgentId&select[1]=ufCrm8AgentName&order[ufCrm8AgentName]=asc`);
                console.log("agent url: ", `${baseUrl}/crm.item.list?entityTypeId=${AGENTS_ENTITY_ID}&select[0]=ufCrm8AgentId&select[1]=ufCrm8AgentName&order[ufCrm8AgentName]=asc`);
